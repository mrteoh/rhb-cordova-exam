...
var DataService = /** @class */ (function () {
    ...
    */
    DataService.prototype.searchData = function (title, type) {
        ...
        // );
        var urlPost = this.url + '?per_page=5&q=' + title;
        console.log('----- urlPost', urlPost);
        return this.http.get(urlPost).pipe(
        // map(results => console.log('----- results',results['total_count']))
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (results) { return results['items']; }));
    };
